...
static const struct ili9806e_init_cmd init_cmds[] = {
	...
	{0xB0,
	 16,
	 {0x0A, 0x14, 0x1B, 0x0D, 0x10, 0x05, 0x07, 0x08, 0x06, 0x22, 0x03, 0x11, 0x10, 0xAD, 0x31,
	  0x1B}},
	{0xB1,
	 16,
	 {0x0A, 0x14, 0x1B, 0x0D, 0x10, 0x05, 0x07, 0x08, 0x06, 0x22, 0x03, 0x11, 0x10, 0xAD, 0x31,
	...
	{0xE2, 12, {0x11, 0x11, 0x44, 0x44, 0x75, 0xA0, 0x00, 0x00, 0x74, 0xA0, 0x00, 0x00}},
	{0xE3, 4, {0x00, 0x00, 0x11, 0x11}},
	{0xE4, 2, {0x44, 0x44}},
	{0xE5,
	 16,
	 {0x0A, 0x71, 0xD8, 0xA0, 0x0C, 0x73, 0xD8, 0xA0, 0x0E, 0x75, 0xD8, 0xA0, 0x10, 0x77, 0xD8,
	  0xA0}},
	{0xE6, 4, {0x00, 0x00, 0x11, 0x11}},
	{0xE7, 2, {0x44, 0x44}},
	{0xE8,
	 16,
	 {0x09, 0x70, 0xD8, 0xA0, 0x0B, 0x72, 0xD8, 0xA0, 0x0D, 0x74, 0xD8, 0xA0, 0x0F, 0x76, 0xD8,
	  0xA0}},
	{0xEB, 7, {0x02, 0x00, 0xE4, 0xE4, 0x88, 0x00, 0x40}},
	{0xEC, 2, {0x3C, 0x00}},
	{0xED,
	 16,
	 {0xAB, 0x89, 0x76, 0x54, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x20, 0x45, 0x67, 0x98,
	  0xBA}},
